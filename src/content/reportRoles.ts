...
export const reportRoleMap: Record<ReportRoleId, ReportRoleDefinition> = {
  ...
  "human-computer": {
    id: "human-computer",
    label: "人型电脑",
    englishLabel: "HUMAN COMPUTER",
    subtitle: "先转成步骤和关系",
    headline: "你常先把复杂信息变成可以逐项处理的结构。",
    scene: "在这组复杂情境里，你有时会先整理输入、条件和步骤。这个称呼不表示更聪明，也不表示缺少情绪。",
    actions: [
      { title: "整理输入", description: "先把事实、条件和待确认信息分开放置。" },
      { title: "转成步骤", description: "把复杂任务变成可以依次处理的操作序列。" },
      { title: "检查输出", description: "回看结构化结果有没有遗漏现场中的人和条件。" },
    ],
    primaryDimension: "organization",
    primarySign: -1,
  },
  "system-maximalist": {
    id: "system-maximalist",
    label: "堆料狂魔",
    englishLabel: "SYSTEM MAXIMALIST",
    subtitle: "先增加覆盖与冗余",
    headline: "你常先补足资源、功能和备用路径。",
    scene: "在这组复杂情境里，你有时会通过增加资源与冗余扩大覆盖，同时也需要留意复杂度代价。",
    actions: [
      { title: "补足资源", description: "先增加能够覆盖主要风险的必要资源。" },
      { title: "建立备用路径", description: "为关键环节准备可切换的冗余方案。" },
      { title: "控制复杂度", description: "检查新增功能是否真的换来了更多有效覆盖。" },
    ],
    assetSrc: "/assets/report-roles/system-maximalist.webp",
    primaryDimension: "organization",
    primarySign: 1,
  },
  "imprint-system": {
  ...
  "momentum-pump": {
    id: "momentum-pump",
    label: "打气筒",
    englishLabel: "MOMENTUM PUMP",
    subtitle: "先让行动重新运转",
    headline: "你常先用反馈和节奏帮助现场恢复推进。",
    scene: "在这组复杂情境里，你有时会先补充反馈、明确下一步，让停滞的行动重新运转；它不表示空洞鼓动。",
    actions: [
      { title: "补充反馈", description: "先让停滞中的人知道什么已经在向前移动。" },
      { title: "缩短下一步", description: "把模糊目标改成可以立即开始的小动作。" },
      { title: "维持节奏", description: "用稳定节奏推进，而不是只靠一次情绪加码。" },
    ],
    assetSrc: "/assets/report-roles/momentum-pump.webp",
    primaryDimension: "scope",
    primarySign: 1,
  },
  "rooted-systems-reader": {
